...
exports.ProcessTransactionError = exports.ProcessTransactionErrorType = void 0;
...
})(ProcessTransactionErrorType || (exports.ProcessTransactionErrorType = ProcessTransactionErrorType = {}));
...
const MFI_ERROR_CODE_MAP = new Map(idl_1.MARGINFI_IDL.errors.map((error) => [error.code, error.msg]));
