...
declare class MarginfiClient {
    ...
    constructor(config: MarginfiConfig, program: MarginfiProgram, wallet: Wallet, isReadOnly: boolean, group: MarginfiGroup, banks: BankMap, priceInfos: OraclePriceMap, mintDatas: MintDataMap, feedIdMap: PythPushFeedIdMap, addressLookupTables?: AddressLookupTableAccount[], preloadedBankAddresses?: PublicKey[], bankMetadataMap?: BankMetadataMap | undefined, sendEndpoint?: string, spamSendTx?: boolean, skipPreflightInSpam?: boolean);
    /**
     ...
     */
    createMarginfiGroup(opts?: TransactionOptions): Promise<PublicKey>;
    /**
     * Create a new lending pool.
     *
     * @returns bank address and transaction signature
     */
    createLendingPool(bankMint: PublicKey, bankConfig: BankConfigOpt, opts?: TransactionOptions): Promise<{
