...
exports.OracleSetup = exports.OperationalState = exports.RiskTier = exports.BankConfig = exports.Bank = void 0;
...
class Bank {
    ...
    static fromBuffer(address, buffer, idl, feedIdMap) {
    ...
    static fromAccountParsed(address, accountParsed, feedIdMap, bankMetadata) {
        ...
        const oracleKey = (0, utils_1.findOracleKey)(config, feedIdMap);
        return new Bank(address, mint, mintDecimals, group, assetShareValue, liabilityShareValue, liquidityVault, liquidityVaultBump, liquidityVaultAuthorityBump, insuranceVault, insuranceVaultBump, insuranceVaultAuthorityBump, collectedInsuranceFeesOutstanding, feeVault, feeVaultBump, feeVaultAuthorityBump, collectedGroupFeesOutstanding, accountParsed.lastUpdate, config, totalAssetShares, totalLiabilityShares, emissionsActiveBorrowing, emissionsActiveLending, emissionsRate, emissionsMint, emissionsRemaining, oracleKey, bankMetadata?.tokenSymbol);
    }
...
})(OperationalState || (exports.OperationalState = OperationalState = {}));
var OracleSetup;
(function (OracleSetup) {
    OracleSetup["None"] = "None";
    OracleSetup["PythLegacy"] = "PythLegacy";
    OracleSetup["SwitchboardV2"] = "SwitchboardV2";
    OracleSetup["PythPushOracle"] = "PythPushOracle";
...
function serializeBankConfigOpt(bankConfigOpt) {
    const assetWeightInit = bankConfigOpt.assetWeightInit && {
        value: [...new bn_js_1.default(bankConfigOpt.assetWeightInit.toString()).toBuffer()],
    };
    const assetWeightMaint = bankConfigOpt.assetWeightMaint && {
        value: [...new bn_js_1.default(bankConfigOpt.assetWeightMaint.toString()).toBuffer()],
    };
    const liabilityWeightInit = bankConfigOpt.liabilityWeightInit && {
        value: [...new bn_js_1.default(bankConfigOpt.liabilityWeightInit.toString()).toBuffer()],
    };
    const liabilityWeightMaint = bankConfigOpt.liabilityWeightMaint && {
        value: [...new bn_js_1.default(bankConfigOpt.liabilityWeightMaint.toString()).toBuffer()],
    };
    ...
    const interestRateConfig = bankConfigOpt.interestRateConfig && {
        insuranceFeeFixedApr: {
            value: [...new bn_js_1.default(bankConfigOpt.interestRateConfig.insuranceFeeFixedApr.toString()).toBuffer()],
        },
        maxInterestRate: { value: [...new bn_js_1.default(bankConfigOpt.interestRateConfig.maxInterestRate.toString()).toBuffer()] },
        insuranceIrFee: { value: [...new bn_js_1.default(bankConfigOpt.interestRateConfig.insuranceIrFee.toString()).toBuffer()] },
        optimalUtilizationRate: {
            value: [...new bn_js_1.default(bankConfigOpt.interestRateConfig.optimalUtilizationRate.toString()).toBuffer()],
        },
        plateauInterestRate: {
            value: [...new bn_js_1.default(bankConfigOpt.interestRateConfig.plateauInterestRate.toString()).toBuffer()],
        },
        protocolFixedFeeApr: {
            value: [...new bn_js_1.default(bankConfigOpt.interestRateConfig.protocolFixedFeeApr.toString()).toBuffer()],
        },
        protocolIrFee: { value: [...new bn_js_1.default(bankConfigOpt.interestRateConfig.protocolIrFee.toString()).toBuffer()] },
    };
...
function computeMaxLeverage(depositBank, borrowBank) {
