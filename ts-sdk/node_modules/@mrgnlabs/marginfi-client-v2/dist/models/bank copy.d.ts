...
declare class Bank {
    ...
    computeUsdValue(oraclePrice: OraclePrice, quantity: BigNumber, priceBias: PriceBias, weight?: BigNumber, scaleToBase?: boolean): BigNumber;
    computeQuantityFromUsdValue(oraclePrice: OraclePrice, usdValue: BigNumber, priceBias: PriceBias): BigNumber;
    getPrice(oraclePrice: OraclePrice, priceBias?: PriceBias): BigNumber;
...
//# sourceMappingURL=bank%20copy.d.ts.map