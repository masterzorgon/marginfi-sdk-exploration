...
import { BankMap, MarginfiClient, MarginfiIdlType, OraclePriceMap, MintData } from "../..";
...
declare class MarginfiAccount {
    ...
    static fromAccountDataRaw(marginfiAccountPk: PublicKey, marginfiAccountRawData: Buffer, idl: MarginfiIdlType): MarginfiAccount;
    ...
    makeDepositIx(program: MarginfiProgram, banks: Map<string, Bank>, mintDatas: Map<string, MintData>, amount: Amount, bankAddress: PublicKey, opt?: MakeDepositIxOpts): Promise<InstructionsWrapper>;
    makeRepayIx(program: MarginfiProgram, banks: Map<string, Bank>, mintDatas: Map<string, MintData>, amount: Amount, bankAddress: PublicKey, repayAll?: boolean, opt?: MakeRepayIxOpts): Promise<InstructionsWrapper>;
    makeWithdrawIx(program: MarginfiProgram, banks: Map<string, Bank>, mintDatas: Map<string, MintData>, amount: Amount, bankAddress: PublicKey, withdrawAll?: boolean, opt?: MakeWithdrawIxOpts): Promise<InstructionsWrapper>;
    makeBorrowIx(program: MarginfiProgram, banks: Map<string, Bank>, mintDatas: Map<string, MintData>, amount: Amount, bankAddress: PublicKey, opt?: MakeBorrowIxOpts): Promise<InstructionsWrapper>;
    ...
    makeLendingAccountLiquidateIx(liquidateeMarginfiAccount: MarginfiAccount, program: MarginfiProgram, banks: Map<string, Bank>, mintDatas: Map<string, MintData>, assetBankAddress: PublicKey, assetQuantityUi: Amount, liabilityBankAddress: PublicKey): Promise<InstructionsWrapper>;
