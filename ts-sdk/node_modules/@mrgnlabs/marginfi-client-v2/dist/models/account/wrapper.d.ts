...
declare class MarginfiAccountWrapper {
    ...
    repayWithCollat(amount: Amount, repayAmount: Amount, bankAddress: PublicKey, repayBankAddress: PublicKey, withdrawAll: boolean | undefined, repayAll: boolean | undefined, swapIxs: TransactionInstruction[], swapLookupTables: AddressLookupTableAccount[], priorityFeeUi?: number, executeTx?: boolean): Promise<string | {
    ...
    makeRepayIx(amount: Amount, bankAddress: PublicKey, repayAll?: boolean, opt?: {
