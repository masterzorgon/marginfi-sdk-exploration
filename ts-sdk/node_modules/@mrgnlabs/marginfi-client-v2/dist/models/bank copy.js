...
exports.parseOracleSetup = exports.parseRiskTier = exports.OracleSetup = exports.RiskTier = exports.BankConfig = exports.Bank = void 0;
...
class Bank {
    ...
    computeUsdValue(oraclePrice, quantity, priceBias, weight, scaleToBase = true) {
    ...
    computeQuantityFromUsdValue(oraclePrice, usdValue, priceBias) {
        const price = this.getPrice(oraclePrice, priceBias);
        return usdValue.div(price);
    }
    getPrice(oraclePrice, priceBias = price_1.PriceBias.None) {
        switch (priceBias) {
    ...
    getEffectiveAssetWeight(marginRequirementType, oraclePrice) {
        switch (marginRequirementType) {
            case account_1.MarginRequirementType.Initial:
...
Asset price (USD): ${this.getPrice(oraclePrice, price_1.PriceBias.None)}
...
exports.Bank = Bank;
class BankConfig {
    constructor(assetWeightInit, assetWeightMaint, liabilityWeightInit, liabilityWeightMaint, depositLimit, borrowLimit, riskTier, totalAssetValueInitLimit, oracleSetup, oracleKeys, interestRateConfig) {
